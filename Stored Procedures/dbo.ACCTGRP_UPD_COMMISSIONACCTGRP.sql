...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[ACCTGRP_UPD_COMMISSIONACCTGRP]
    @cv_1 VARCHAR(2000) OUTPUT,
    @p_account_group_id NUMERIC,
    @p_commission_account_group_id NUMERIC
AS
BEGIN
    ...
    SET PARTNER_ACCOUNT_GROUP_ID = @p_commission_account_group_id
    WHERE ACC_ACCOUNT_GROUPS.ACCOUNT_GROUP_ID = @p_account_group_id;

    /* Return current state of Account Group.*/
