...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[ACC_REPORTS_PACKAGE$rpt_monthly_acq_costs_incurred] @p_recordset VARCHAR(2000) OUTPUT
AS
BEGIN
    ...
    EXECUTE dbo.ACC_REPORTS_PACKAGE$rpt_period_acq_costs_incurred @p_recordset = @p_recordset OUTPUT,
