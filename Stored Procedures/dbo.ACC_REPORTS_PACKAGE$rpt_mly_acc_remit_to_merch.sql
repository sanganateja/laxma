...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[ACC_REPORTS_PACKAGE$rpt_mly_acc_remit_to_merch]
...
BEGIN
    ...
    EXECUTE dbo.ACC_REPORTS_PACKAGE$rpt_acc_remit_to_merch @p_recordset = @p_recordset OUTPUT,
