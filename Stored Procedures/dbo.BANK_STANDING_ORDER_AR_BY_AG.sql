...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[BANK_STANDING_ORDER_AR_BY_AG]
...
BEGIN
    ...
    WHERE ACC_BANK_STANDING_ORDERS.STATUS = 'A'
          AND ACC_BANK_STANDING_ORDERS.FREQUENCY_UNITS = 'R'
          AND ACC_BANK_STANDING_ORDERS.ACCOUNT_GROUP_ID = @p_account_group_id;
