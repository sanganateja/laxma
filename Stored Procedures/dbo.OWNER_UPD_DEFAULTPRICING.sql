...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[OWNER_UPD_DEFAULTPRICING]
    @cv_1 VARCHAR(2000) OUTPUT,
    @p_owner_id NUMERIC,
    @p_dflt_pricing_tier_id NUMERIC,
    @p_dflt_pricing_tur_band_id NUMERIC,
    @p_dflt_pricing_policy_id NUMERIC
AS
BEGIN
    ...
    SET DFLT_PRICING_TIER_ID = @p_dflt_pricing_tier_id,
        DFLT_PRICING_TURNOVER_BAND_ID = @p_dflt_pricing_tur_band_id,
        DEFAULT_PRICING_POLICY_ID = @p_dflt_pricing_policy_id
