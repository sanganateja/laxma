...
SET ANSI_NULLS ON
GO
CREATE   PROCEDURE [dbo].[spCostMastercardInterchangeFeeMatches]
...
BEGIN
    ...
    SELECT x.FeeId,
           ...
           x.CappedMajorUnit,
           x.FixedCurrency,
           x.PosTerminalInputCapability,
           x.CardDataInputMode,
           x.CardholderPresentData,
           x.CardPresentData,
           x.CardholderAuthCapability,
           x.CardholderAuthMethod,
           x.Icc,
           x.TimelinessDays,
           x.ServiceCode,
           x.AccFundingSource,
           x.ProductType,
           x.CardProgIdentifier,
           x.GcmsProductIdentifier,
           x.Mti,
           x.FunctionCode,
           x.ProcessingCode,
           x.CabProgramInclude,
           x.CabProgramExcludes,
           x.MccInclude,
           x.MccExcludes,
           x.ApprovalCode,
           x.CorporateCardCommonData,
           x.CorporateLineItemDetail
      FROM (
           SELECT mif.FeeId,
                  mif.EffectiveFrom,
                  mif.EffectiveUntil,
